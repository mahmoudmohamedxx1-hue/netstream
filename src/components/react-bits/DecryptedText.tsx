...
export default function DecryptedText({
  ...
  return (
    <motion.span
      ...
      ref={containerRef}
      style={{ ...styles.wrapper, position: 'relative', overflow: 'visible' }}
      {...animateProps}
      {...props}
    >
      {/* Screen-reader text — absolute positioned so it doesn't affect layout */}
      <span style={{ ...styles.srOnly, position: 'absolute' }}>{displayText}</span>
