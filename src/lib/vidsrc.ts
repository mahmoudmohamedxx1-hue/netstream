...
const TIER_1D: VideoSource[] = [
  ...
  },
  {
    ...
    mobile: true,
    region: "Global",
    buildMovie: (id) => `https://vidsrc.xyz/embed/movie?imdb=${id}`,
    buildSeries: (id, s, e) => `https://vidsrc.xyz/embed/tv?imdb=${id}&season=${s}&episode=${e}`,
  },
  {
    id: "multiembed.mov",
    name: "MultiEmbed",
  ...
  },
  {
    ...
    mobile: true,
    region: "Global",
    buildMovie: (id) => `https://vidsrc.stream/movie?imdb=${id}`,
    buildSeries: (id, s, e) => `https://vidsrc.stream/tv?imdb=${id}&season=${s}&episode=${e}`,
  },
  {
    id: "2embed.org",
    name: "2Embed.org",
